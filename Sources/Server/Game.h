...
// Follower modes	
	...
	// v1.4311-3 ÇÔ¼ö ¼±¾ð ÀÔÀå±Ç ¹Þ´Â ÇÔ¼ö .. void GetFightzoneTicketHandler(int iClientH);
...
//crafting:
	...
	// v1.4311-3 º¯¼ö ¼±¾ð  ¿¹¾àµÈ ½Ã°£À» °¡Áö´Â º¯¼ö DWORD m_dwCanFightzoneReserveTime 
	DWORD m_dwCanFightzoneReserveTime ;

	// v1.4311-3 º¯¼ö ¼±¾ð °¢ »çÅõÀåÀÇ ¿¹¾à ¿©ºÎ¸¦ ÀúÀå int  m_iFightZoneReserve[DEF_MAXFIGHTZONE];
